...
class Verdict(NamedTuple):
    ...
    verdict     PROVEN | WRONG | SUSPECTED-FOLD | NO-COMPILE
...
def _run(candidate: str, reference: str, opt: str):
...
def check(candidate: str, reference: str) -> Verdict:
    ...
    out, dt = _run(candidate, reference, "-O3")
    ...
    out, dt2 = _run(candidate, reference, "-O1")
    if out is None or not out.strip():
